...
$atts = $new_paper_helper->set_default('no_of_posts', 4 , $atts);
$atts = $new_paper_helper->set_default('title', esc_html__('Two Columns Vertical Posts', 'new-paper') , $atts);
...
if($custom_query->have_posts()){
    ...
    <div class="row <?php echo esc_attr($css_class) ?>">
        ...
        while($custom_query->have_posts()){
            ...
            $data['image_url'] = aq_resize($image_url, 370, 260, true, true, true); // X2
