<?php
function new_paper_ntx_two_columns_vertical_posts_fn() {

    global $new_paper_helper;

    vc_map( array(
        'name' => esc_html__('Two Columns Vertical Posts', 'new-paper'),
        'base' => 'new_paper_ntx_two_columns_vertical_posts',
        ...
        'params' => array(
            ...
            array(
                ...
                'description' => esc_html__('Default: 4', 'new-paper'),
...
new_paper_ntx_two_columns_vertical_posts_fn();

class WPBakeryShortCode_New_Paper_Ntx_Two_Columns_Vertical_Posts extends WPBakeryShortCode {
}
