<?php
function new_paper_ntx_suggested_posts_fn() {

    global $new_paper_helper;

    vc_map( array(
        'name' => esc_html__('Suggested Posts', 'new-paper'),
        'base' => 'new_paper_ntx_suggested_posts',
        ...
        'params' => array(
            ...
            array(
                ...
                'description' => esc_html__('Default: 3', 'new-paper'),
...
new_paper_ntx_suggested_posts_fn();

class WPBakeryShortCode_New_Paper_Ntx_Suggested_Posts extends WPBakeryShortCode {
}
