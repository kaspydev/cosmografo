<?php
function new_paper_ntx_triangular_posts_fn() {

    global $new_paper_helper;

    vc_map( array(
        'name' => esc_html__('Two Column Triangular Posts', 'new-paper'),
        'base' => 'new_paper_ntx_triangular_posts',
...
new_paper_ntx_triangular_posts_fn();

class WPBakeryShortCode_New_Paper_Ntx_Triangular_Posts extends WPBakeryShortCode {
}
